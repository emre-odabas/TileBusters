...
namespace Lean.Gui
{
	...
	{
		[ReadOnly] public Camera currentCamera;
		...
		protected virtual void Update()
		{
			...
			if (pointer != null)
			{
				if (IsInteractable() == true)
				{
					...
					if (RectTransformUtility.ScreenPointToLocalPointInRectangle(CachedRectTransform, pointer.position, currentCamera, out value) == true)
					{
						value -= offset;
					}
				}
		...
		public override void OnPointerDown(PointerEventData eventData)
		{
			...
			if (pointer == null && IsInteractable() == true)
			{
				...
				if (relativeToOrigin == false)
				{
					...
					origin = RectTransformUtility.WorldToScreenPoint(currentCamera, worldPoint);
				}

				//RectTransformUtility.ScreenPointToLocalPointInRectangle(CachedRectTransform, origin, pointer.pressEventCamera, out offset);
				RectTransformUtility.ScreenPointToLocalPointInRectangle(CachedRectTransform, origin, currentCamera, out offset);
